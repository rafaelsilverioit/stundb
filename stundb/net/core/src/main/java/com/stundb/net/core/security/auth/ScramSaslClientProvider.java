 ...
 * org.apache.kafka.common.security.scram.internals.ScramSaslClientProvider. It has been heavily
...
public final class ScramSaslClientProvider extends Provider {
    ...
    private ScramSaslClientProvider() {
        super("SASL/SCRAM Client Provider", "1.0", "SASL/SCRAM Client Provider for StunDB");
        put(
                "SaslClientFactory." + ScramMechanism.SCRAM_SHA_256.mechanismName(),
                ScramSaslClient.ScramSaslClientFactory.class.getName());
    }
