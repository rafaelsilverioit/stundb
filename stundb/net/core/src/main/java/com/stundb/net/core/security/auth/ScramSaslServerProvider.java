 ...
 * org.apache.kafka.common.security.scram.internals.ScramSaslServerProvider. It has been heavily
...
public final class ScramSaslServerProvider extends Provider {
    ...
    private ScramSaslServerProvider() {
        super("SASL/SCRAM Server Provider", "1.0", "SASL/SCRAM Server Provider for StunDB");
        put(
                "SaslServerFactory." + ScramMechanism.SCRAM_SHA_256.mechanismName(),
